...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, SFT_T(KC_BSLS), \
      LCTL(KC_SPC),          KC_LALT, KC_LGUI, KC_ESC,           KC_LOSP, KC_TAB,  KC_BSPC,KC_ENT,         KC_RADOT,KC_RCTL, KC_RGUI,          KC_RALT \
      ),
  [_LOWER] = LAYOUT( \
