...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT( \
      KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_LPRN,                   KC_RPRN, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
      KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,                   KC_RBRC, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_BSPC, \
      KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_EQL,                    KC_MINS, KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, \
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_N,    KC_M,    KC_COMM,  KC_DOT, KC_SLSH, SFT_T(KC_BSLS), \
      LCTL(KC_SPC),  KC_LALT, KC_LGUI, LT(_LOWER, KC_ESC),  KC_SPC, SFT_T(KC_TAB),   KC_BSPC, KC_ENT,         MO(_RAISE),    KC_RGUI, KC_RGUI,          KC_RALT \
      ),
  [_LOWER] = LAYOUT( \
