...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    KC_EQL,   KC_LALT, KC_LGUI, KC_PSCR, KC_ESC, LT(SYMB, KC_SPC), SFT_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_DELT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
   ...
   * |   `  |   1  |   2  |   3  |   4  |   5  |  [   |   |  ]   |   6  |   7  |   8  |   9  |   0  |      |
   * |------+------+------+------+------+------+------|   |-------------+------+------+------+------+------|
   * | Alt  |   1  |   2  |   3  |   4  |   5  |  (   |   |  )   | Left | Down |  Up  | Right|   0  |  =   |
   * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
   ...
   */
  [META] = LAYOUT( \
    KC_GRV,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, KC_6,    KC_7,    KC_8,  KC_9,    KC_0, XXXXXXX, \
    _______,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,    KC_0, KC_EQL, \
