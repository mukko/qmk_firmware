...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT( \
    ...
    LGUI(KC_SPC),   KC_LALT, KC_LGUI, KC_PSCR, KC_ESC, LT(SYMB, KC_SPC), SFT_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_DELT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
