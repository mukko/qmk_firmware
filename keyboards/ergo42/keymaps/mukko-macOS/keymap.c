...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * |  =   | Alt  |  GUI |PrtSc |ESC/  |Space/|Tab/  |   |Back  |Enter/| Del  | Left | Down |  Up  | Right|
  ...
  [BASE] = LAYOUT( \
    ...
    KC_EQL,   KC_LALT, KC_LGUI, KC_PSCR, LT(SYMB, KC_ESC), GUI_T(KC_SPC), SFT_T(KC_TAB), KC_BSPC,    LT(META, KC_ENT), KC_DELT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
  ),
